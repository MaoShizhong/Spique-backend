const { channelUserIDs, messageIDs, channelIDs } = require('./test_IDs');
const { ObjectId } = require('mongoose').Types;

exports.messages = [
    {
        _id: messageIDs[0],
        user: channelUserIDs[0],
    ...
    {
        _id: messageIDs[2],
        user: channelUserIDs[1],
        channel: channelIDs[0],
        timestamp: new Date('2023-10-07T05:24:00'),
        text: 'user1->user0 message2',
    },
    ...generateManyTestMessages(90, channelIDs[1], channelUserIDs[2]),
];
